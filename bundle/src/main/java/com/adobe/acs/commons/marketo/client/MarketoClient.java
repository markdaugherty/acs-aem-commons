...
public interface MarketoClient {
     ...
     */
    @Nonnull String getApiToken(@Nonnull MarketoClientConfiguration config) throws MarketoApiException;
     ...
     */
    @Nonnull CloseableHttpClient getHttpClient();
     ...
     */
    @Nonnull List<MarketoForm> getForms(@Nonnull MarketoClientConfiguration config) throws MarketoApiException;
     ...
     * @throws IOException an exception occurs interacting with the API
     */
    @Nonnull List<MarketoField> getFields(@Nonnull MarketoClientConfiguration config) throws MarketoApiException;
